    ...
    >
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 border-b border-[#1D1B14] bg-[#0C0B08]/90 backdrop-blur-xl">
        <div className="mx-auto max-w-6xl px-5 sm:px-8 py-3 flex items-center justify-between">
          ...
          >
            ...
            <em style={{ fontStyle: "italic", color: "#C8923A" }}>
              Inteligente
            </em>
          </Link>
      ...
      <section className="relative min-h-screen flex items-center pt-16 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, transparent, rgba(200,146,58,0.07) 45%, transparent)",
          }}
        />
        ...
        <div className="relative mx-auto max-w-6xl px-5 sm:px-8 w-full py-24 sm:py-32">
          <div className="max-w-3xl">
            ...
            <p className="hero-sub mb-10 text-[#5E5849] text-base sm:text-lg leading-relaxed max-w-lg">
              ...
              <strong className="text-[#EDE4D3]/50 font-medium">90 dias</strong>
              , semana a semana, com tudo que você precisa para sair do lugar e
              chegar onde quer.
            </p>
            ...
            <div className="hero-cta flex flex-col sm:flex-row items-start sm:items-center gap-5">
              ...
              >
                <span style={{ fontFamily: "var(--font-dm)" }}>
                  Quero meu plano
                </span>
                <svg
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, #C8923A, transparent)",
        }}
      />
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={t} className="flex items-start gap-4">
                    ...
                    <p className="text-[14px] text-[#3E3A30] leading-relaxed">
                      {t}
                    </p>
                  </div>
                ))}
            ...
            <div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={t} className="flex items-start gap-4">
                    <span className="text-[#C8923A] text-sm mt-0.5 shrink-0 w-4">
                      →
                    </span>
                    <p className="text-[14px] text-[#7A7068] leading-relaxed">
                      {t}
                    </p>
                  </div>
                ))}
            ...
            {[
              {
                ...
                desc: "Os 3 principais obstáculos que travam seu crescimento e como resolver cada um deles.",
              },
              {
                n: "02",
                title: "Plano 90 dias",
                desc: "12 semanas com objetivos, ações e entregáveis claros — você sabe o que fazer cada dia.",
              },
              {
                n: "03",
                title: "Recursos sob medida",
                desc: "Cursos, livros e materiais selecionados para sua área e estilo de aprendizado.",
              },
              {
                n: "04",
                title: "Script de promoção",
                desc: "Argumentos personalizados e o momento certo para abordar o assunto com seu gestor.",
              },
              {
                n: "05",
                title: "Resumo executivo",
                desc: "Análise profunda do seu perfil, oportunidades e viabilidade do seu objetivo.",
              },
              {
                n: "06",
                title: "PDF profissional",
                desc: "Baixe seu plano completo em PDF e acesse quando quiser, de qualquer lugar.",
              },
            ].map((item) => (
              <Reveal key={item.n}>
                <div className="group bg-[#0F0E0B] p-8 h-full transition-colors duration-300 hover:bg-[#131109]">
                  ...
                  <p className="text-[13px] text-[#3E3A30] leading-relaxed">
                    {item.desc}
                  </p>
                </div>
              </Reveal>
            ...
            {[
              {
                ...
                desc: "Responda perguntas sobre seu cargo, objetivo, habilidades e o que te falta. Leva menos de 5 minutos.",
              },
              {
                n: "02",
                title: "Faça o pagamento",
                desc: "Pague via PIX (R$24,90) ou cartão (R$27,90). Compra única, sem assinatura.",
              },
              {
                n: "03",
                title: "Receba seu plano",
                desc: "Em menos de 2 minutos, seu plano personalizado de 90 dias está pronto. Você também recebe por email.",
              },
            ].map((step, idx) => (
              <Reveal key={step.n} delay={idx * 80}>
                <div className="grid grid-cols-[72px_1fr] sm:grid-cols-[110px_1fr] items-start border-b border-[#1D1B14] py-10 gap-6">
                  ...
                  <div className="pt-1.5">
                    ...
                    <p className="text-[14px] text-[#3E3A30] leading-relaxed max-w-md">
                      {step.desc}
                    </p>
                  </div>
                </div>
            ...
            {[
              {
                ...
                text: "Em 2 meses seguindo o plano, consegui a promoção que esperava há mais de 1 ano. O script de conversa com meu gestor fez toda a diferença.",
                initials: "MS",
              },
              {
                name: "Rafael C.",
                role: "Desenvolvedor Junior",
                text: "O plano me mostrou exatamente os gaps que eu não enxergava. Comecei a estudar as coisas certas e em 3 meses passei para pleno.",
                initials: "RC",
              },
              {
                name: "Camila O.",
                role: "Coordenadora de RH",
                text: "Estava perdida sobre como crescer na carreira. O PlanoAI me deu um roteiro claro com ações práticas para cada semana. Super recomendo.",
                initials: "CO",
              },
            ].map((d) => (
              <Reveal key={d.name}>
                <div className="bg-[#0F0E0B] p-8 flex flex-col h-full">
                  ...
                  <div className="flex items-center gap-3 border-t border-[#1D1B14] pt-5">
                    ...
                    <div>
                      <p className="text-[13px] font-medium text-[#EDE4D3]">
                        {d.name}
                      </p>
                      <p
      ...
      <footer className="border-t border-[#1D1B14] py-8 px-5 sm:px-8">
        <div className="mx-auto max-w-6xl flex flex-wrap items-center justify-between gap-4">
          ...
          >
            <Link
              href="/privacidade"
              className="hover:text-[#C8923A]/60 transition-colors duration-200"
            >
              PRIVACIDADE
            </Link>
            <Link
